...
const ERP_DATA = {
  ...
  leads: [
    {
      ...
      phone: "+54 9 11 6284-9102",
      email: "carlos.mendoza@gmail.com",
      channel: "Filtro Web Os-Car",
      vehicleInterest: "Toyota SW4 4x4 7 Asientos (2012)",
      status: "negociacion",
      stage: "negociacion",
      assignedSeller: "Martín Benítez",
    ...
    {
      id: "LEAD-1047",
      name: "Jorge Luis Domínguez",
      fullName: "Jorge Luis Domínguez",
      phone: "+54 9 11 3948-2019",
    ...
    {
      id: "LEAD-1046",
      name: "Romina Soledad Varela",
      fullName: "Romina Soledad Varela",
      phone: "+54 9 11 7193-4029",
    ...
    {
      id: "LEAD-1045",
      name: "Marcelo Damián Russo",
      fullName: "Marcelo Damián Russo",
      phone: "+54 9 11 5820-9411",
      email: "marcelo.russo@abogados.com.ar",
      channel: "Teléfono",
      vehicleInterest: "Ford Focus SE Plus 2017",
      status: "cerrado",
      stage: "cerrado",
      assignedSeller: "Roberto Páez",
      sellerAssigned: "Roberto Páez",
      date: "2026-09-10",
      notes: "Operación de contado cerrada y transferida exitosamente."
    }
  ],
  ...
  tradeIns: [
    {
      id: "TOMA-042",
      name: "Chevrolet Celta 1.4 Advantage 5P",
      vehicleDesc: "Chevrolet Celta 1.4 Advantage 5P",
      date: "2026-09-14",
      relatedSaleId: "VTA-2026-089",
      clientName: "Esteban Marcos Bianchi",
      clientPhone: "+54 9 11 4829-1029",
      year: 2014,
      km: 112000,
      patente: "OPI 924",
      image: "assets/vehicles/chevrolet-onix.png",
      pretendedValue: 11200000,
      valorTasadoOfrecido: 9800000,
      offeredPrice: 10000000,
      valorTasadoAprobado: 10000000,
      projectedResale: 12500000,
      reconditioningCost: 450000,
      margin: "20.5%",
      inspectionScore: 94,
      checklistSummary: "Frenos, tren delantero y detalles menores",
      dnrpaStatus: "aprobado",
      status: "tasacion_aprobada",
      statusLabel: "Tasación Aprobada",
    ...
    {
      id: "TOMA-041",
      name: "Toyota Corolla 1.8 XEI Manual",
      vehicleDesc: "Toyota Corolla 1.8 XEI Manual",
      date: "2026-09-16",
      relatedSaleId: null,
      clientName: "Carlos Eduardo Mendoza",
      clientPhone: "+54 9 11 6284-9102",
      year: 2017,
      km: 89000,
      patente: "AB 491 QZ",
      image: "assets/vehicles/toyota-corolla.jpg",
      pretendedValue: 18500000,
      valorTasadoOfrecido: 17200000,
      offeredPrice: 16800000,
      valorTasadoAprobado: 16800000,
      projectedResale: 20400000,
      reconditioningCost: 320000,
      margin: "19.5%",
      inspectionScore: 98,
      checklistSummary: "Pintura de fábrica, service oficial Toyota",
      dnrpaStatus: "aprobado",
      status: "en_peritaje",
      statusLabel: "En Peritaje",
    ...
    },
    {
      ...
      vehicleDesc: "Peugeot 208 Allure 1.6",
      date: "2026-09-12",
      relatedSaleId: null,
      clientName: "Valeria Noemí Giménez",
      clientPhone: "+54 9 11 5912-3819",
      year: 2019,
      km: 67000,
      patente: "AD 319 KL",
      image: "assets/vehicles/peugeot-208.jpg",
      pretendedValue: 14200000,
      valorTasadoOfrecido: 12800000,
      offeredPrice: 13000000,
      valorTasadoAprobado: 13000000,
      projectedResale: 15800000,
      reconditioningCost: 410000,
      margin: "18.4%",
      inspectionScore: 91,
      checklistSummary: "Cambio de pastillas y pulido",
      dnrpaStatus: "en_tramite",
      status: "tasacion_aprobada",
      statusLabel: "Tasación Aprobada",
      observacionesMecanicas: "Buen estado general, titular directo, sin infracciones pendientes."
    }
  ],
  ...
  workshopJobs: [
    {
      ...
      technician: "Marcos Medina",
      priority: "alta",
      entryDate: "2026-09-12",
      estimatedDelivery: "2026-09-19",
      costTotal: 620000,
      cost: 620000,
      checklistSummary: "Fluidos, distribución y cerámico 3M",
      supplier: "Taller Central Os-Car",
      tasks: [
    ...
    },
    {
      ...
      technician: "Esteban Roldán",
      priority: "media",
      entryDate: "2026-09-14",
      estimatedDelivery: "2026-09-20",
      costTotal: 480000,
      cost: 480000,
      checklistSummary: "Pastillas de freno, bujías y filtros",
      supplier: "Repuestos Varela Sur",
      tasks: [
    ...
    },
    {
      ...
      costTotal: 210000,
      cost: 210000,
      checklistSummary: "Alistamiento 0KM y sellado acrílico",
      supplier: "Detailing Center Os-Car",
      tasks: [
    ...
    },
    {
      ...
      costTotal: 340000,
      cost: 340000,
      checklistSummary: "Desparafinado y tacógrafo homologado",
      supplier: "Tacógrafos Varela",
      tasks: [
  ...
  transfers: [
    {
      ...
      buyerName: "Transportes El Halcón S.A.",
      buyerCuit: "30-71492011-4",
      buyerDni: "30-71492011-4",
    ...
    },
    {
      ...
      buyerName: "Dr. Marcelo Damián Russo",
      buyerCuit: "20-33819402-9",
      buyerDni: "20-33819402-9",
      gestor: "Dra. Lorena Peralta",
    ...
    },
    {
      ...
      buyerName: "Gonzalo Javier Nieva",
      buyerCuit: "20-38491022-3",
      buyerDni: "20-38491022-3",
    ...
    },
    {
      ...
      buyerName: "Agropecuaria Los Manantiales",
      buyerCuit: "30-64810294-7",
      buyerDni: "30-64810294-7",
      gestor: "Dra. Lorena Peralta",
  ...
  webPublications: [
    ...
    },
    {
      ...
      vehicleId: "fiat-cronos-drive-pack",
      name: "Fiat Cronos Drive Pack Conect",
      vehicleName: "Fiat Cronos Drive Pack Conect",
      image: "assets/vehicles/fiat-cronos.png",
      patente: "0KM",
      condition: "0km",
      photosCount: 14,
  ...
  appointments: [
    {
      ...
      clientName: "Martín Alejandro Benítez",
      phone: "+54 9 11 4912-3841",
      clientPhone: "+54 9 11 4912-3841",
      vehicle: "Honda HR-V EX CVT 0KM",
      vehicleName: "Honda HR-V EX CVT 0KM",
      seller: "Roberto Páez",
      advisor: "Roberto Páez",
      status: "confirmado",
    ...
    },
    {
      ...
      clientName: "Gonzalo Javier Nieva",
      phone: "+54 9 11 3849-1022",
      clientPhone: "+54 9 11 3849-1022",
      vehicle: "Fiat Cronos Drive Pack 0KM",
      vehicleName: "Fiat Cronos Drive Pack 0KM",
      seller: "Carlos Gómez",
